...
public class TitleTextViewType12 extends CommonTextView {
    public TitleTextViewType12(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public TitleTextViewType12(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TitleTextViewType12(Context context) {
        super(context);
    }
        ...
        switch (getTextStyle()) {
            case NORMAL: /*latoxregular,mehr_master,laila_regular_hin*/
                if (MyService.getSelectedLanguage() == Enums.LANGUAGE.URDU)
                    ...
                    fontName = R.font.merriweather_bold_eng;
                } else
                    fontName = R.font.laila_regular;
                break;
            case BOLD: /*lato bold,mehr_master,NotoDevanagaribold*/
                if (MyService.getSelectedLanguage() == Enums.LANGUAGE.URDU)
                    fontName = R.font.noto_nastaliq_regular_urdu;
                else if (MyService.getSelectedLanguage() == Enums.LANGUAGE.ENGLISH) {
            ...
            case ITALIC: /*latoxitalic,mehr_master,NotoDevanagari*/
                if (MyService.getSelectedLanguage() == Enums.LANGUAGE.URDU) {
                    ...
                    fontName = R.font.merriweather_italic_eng;
                }
                break;

            case BOLD_ITALIC:  /*merriweather_extendedLtIt,lailaregular,noto_nastaliq_regular_urdu*/
//                if (MyService.getSelectedLanguage() == Enums.LANGUAGE.URDU)
//                    fontName = R.font.noto_nastaliq_regular_urdu;
//                else if (MyService.getSelectedLanguage() == Enums.LANGUAGE.HINDI) {
