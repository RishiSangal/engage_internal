...
public class TitleTextViewType6 extends CommonTextView {
    public TitleTextViewType6(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public TitleTextViewType6(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TitleTextViewType6(Context context) {
        super(context);
    }
