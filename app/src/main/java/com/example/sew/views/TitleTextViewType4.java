...
public class TitleTextViewType4 extends CommonTextView {
    public TitleTextViewType4(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public TitleTextViewType4(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TitleTextViewType4(Context context) {
        super(context);
    }
