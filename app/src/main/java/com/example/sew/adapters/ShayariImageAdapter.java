...
public class ShayariImageAdapter extends BaseMyAdapter {
    private ArrayList<ShayariImage> shayariImages;
    public ShayariImageAdapter(BaseActivity activity, ArrayList<ShayariImage> shayariImages) {
        super(activity);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = getInflatedView(R.layout.cell_shayari_image);
