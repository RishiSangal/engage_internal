...
public class Enums {
    ...
    public enum LIST_RENDERING_FORMAT {GHAZAL, NAZM, SHER, AUDIO, VIDEO, PROFILE,IMAGE_SHAYRI,QUOTE,RUBAI}

    public enum TEXT_ALIGNMENT {LEFT, CENTER}

    public enum CRITIQUE_TYPE {FEEDBACK, CRITIQUE}

    public enum PLACEHOLDER_TYPE {PROFILE, PROFILE_LARGE, SHAYARI_IMAGE, SHAYARI_COLLECTION, PROMOTIONAL_BANNER,USER_INFO_BANNER}
