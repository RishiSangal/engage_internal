...
public class ContentSortSherPopupWindow extends RelativePopupWindow {
    BaseActivity activity;
    public PoetSherFragment fragment;
    ViewHolder viewHolder;
    private String contentTitle;
    String sortedBy;
    public ContentSortSherPopupWindow(BaseActivity context, String contentTitle, PoetSherFragment fragment,String sortedBy) {
    ...
    class ViewHolder {
        ContentSortSherPopupWindow contentSortPopupWindow;
        ...
        ViewHolder(View view, ContentSortSherPopupWindow contentSortPopupWindow) {
